...
resume = pd.read_csv("resume.csv",encoding='cp1252')
resume.head()
resume.info()
resume.isnull().sum()
...
tfidf_jd = tfidf_vectorizer.transform(jd_user_q['desc'])
